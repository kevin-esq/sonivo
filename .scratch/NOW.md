...
| Wave A T-W32-00 | ADR-0032 PROPOSED docs + PHASE-WHISPER-SPEC.md skeleton (docs only) | IN PROGRESS on `docs/adr-0032-whisper`; human approval PENDING; NOT merged |
| ADR-0032+ | Whisper audio digitizer thin implementation (T-W32-01–03) | NEXT (needs ADR-0032 ACCEPTED before impl) |
